    ...
    <main className={styles.shell} lang={locale}>
      <section className={styles.brandPanel}>
        ...
        <div className={styles.brandCopy}>
          <p className={styles.eyebrow}>{t.auth.signUpEyebrow}</p>
      ...
      <section className={styles.formPanel}>
        <div className={styles.card}>
          <header className={styles.header}>
            ...
            <p>{t.auth.signUpIntro}</p>
          </header>

          <EnglishAuthForm locale={locale} mode="signup" />

          <p className={styles.footer}>
            {t.auth.already} <Link href={`${prefix}/sign-in`}>{t.common.signIn}</Link>
          </p>
        </div>
      </section>
    </main>
