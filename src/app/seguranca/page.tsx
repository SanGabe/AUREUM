...
const cards = [
  ["01","Isolamento por Household","Row Level Security limita o acesso aos dados que pertencem aos espaços financeiros dos quais o usuário realmente faz parte."],
  ...
  return (
    <MarketingShell active="seguranca">
      <PageHero
        ...
        description="A segurança do AUREUM nasce na arquitetura: autenticação, isolamento por Household, permissões e revisão antes de transformar informação em registro oficial."
      />
