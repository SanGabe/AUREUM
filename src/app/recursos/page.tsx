...
const items = [
  ["01", "Contas em um só lugar", "Organize conta corrente, carteira, poupança e investimentos por Household e moeda."],
  ...
  ["06", "Household e permissões", "Compartilhe a vida financeira com regras claras para proprietário, administrador, colaborador e membro."],
];
        ...
        <div className={styles.split}>
          ...
          <div className={styles.splitCopy}>
            ...
            <div className={styles.checks}>
              <div className={styles.check}><span>✓</span><div><strong>Web como centro de controle</strong><p>Revisão, gestão, Household e análise em uma interface completa.</p></div></div>
