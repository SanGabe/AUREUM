  ...
  return (
    <main className={styles.page} lang={locale}>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerColumn}><strong>Product</strong><Link href={`${prefix}/resources`}>Features</Link><Link href={`${prefix}/for-whom`}>Who it is for</Link><Link href={`${prefix}/demo`}>Demo</Link></div>
